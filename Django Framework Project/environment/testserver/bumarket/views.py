...
def createProduct(request): 
    ...
    if request.method == "POST":
        ...
        try:
            ...
            queryset = ProductModel.objects.create(ProductName=ProductNameJson, ProductCategory=ProductCategoryJson, ProductPrice=ProductPriceJson, ProductDate=ProductDateJson, ProductText=ProductTextJson, ProductType=ProductTypeJson,UserId=UserModel.objects.get(UserId='0020'))
            JsonResult = JsonData
