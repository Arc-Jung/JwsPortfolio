    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ImageId', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='protype.ImageModel')),
                ('UserId', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='protype.UserModel')),
            ],
        ),
        migrations.CreateModel(
            name='SaleModel',
            fields=[
                ...
                ('ProductId', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='protype.ProductModel')),
            ],
        ),
        migrations.CreateModel(
            name='ProImageModel',
        ...
        migrations.AddField(
            ...
            name='UserId',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='protype.UserModel'),
        ),
        migrations.CreateModel(
            name='LikeModel',
            fields=[
